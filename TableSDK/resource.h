...
// "not built for this toolchain/architecture" (e.g. payload/lib/msvc/x86/table.lib
// is a 0-byte placeholder until a real 32-bit MSVC build is dropped in).
#define ID_RES_HEADER        3001
#define ID_RES_MSVC_LIB_X64  3002
#define ID_RES_MSVC_LIB_X86  3004
#define ID_RES_MINGW_LIB_X64 3003
#define ID_RES_MINGW_LIB_X86 3005
